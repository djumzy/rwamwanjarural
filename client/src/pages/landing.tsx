    ...
    <div className="bg-gray-50">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
                <div className="flex items-start space-x-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Training refugees and rural communities in Uganda with practical skills that transform landscapes and create sustainable livelihoods for generations.
                    </p>
                  </div>
                </div>
        ...
        <section className="py-20 px-4 bg-gray-50">
          <div className="max-w-6xl mx-auto">
            ...
            <Card className="text-center">
              <CardHeader>
                <div className="w-12 h-12 bg-rrf-light-green rounded-full flex items-center justify-center mx-auto mb-2">
                  <Target className="text-rrf-dark-green w-6 h-6" />
                </div>
                <CardTitle className="text-rrf-green">Mission</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-700">
                  Empower refugee and host communities through regenerative education and ecological restoration.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              <CardHeader>
                <div className="w-12 h-12 bg-rrf-light-green rounded-full flex items-center justify-center mx-auto mb-2">
                  <Eye className="text-rrf-dark-green w-6 h-6" />
                </div>
                <CardTitle className="text-rrf-green">Vision</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-700">
                  A food-secure, ecologically restored Africa led by resilient refugee communities.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              <CardHeader>
                <div className="w-12 h-12 bg-rrf-light-green rounded-full flex items-center justify-center mx-auto mb-2">
                  <Heart className="text-rrf-dark-green w-6 h-6" />
                </div>
                <CardTitle className="text-rrf-green">Values</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-700">
                  Regeneration • Resilience • Inclusion • Sustainability • Community-Led • Collaboration
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <Card>
              <CardContent className="p-6">
                <h4 className="font-semibold text-gray-900 mb-3">Limited Training Funding</h4>
                <p className="text-gray-700">
                  Traditional onsite training programs face significant funding constraints, limiting reach and impact.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6">
                <h4 className="font-semibold text-gray-900 mb-3">Food Insecurity Crisis</h4>
                <p className="text-gray-700">
                  Rising food insecurity and land degradation in refugee settlements require urgent action.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6">
                <h4 className="font-semibold text-gray-900 mb-3">Scalable Solutions Needed</h4>
                <p className="text-gray-700">
                  Need for scalable, inclusive, and cost-effective learning solutions to reach more communities.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="text-center mb-16">
            <h3 className="text-2xl font-bold text-rrf-green mb-8">E-Learning for Regeneration</h3>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 bg-rrf-light-green rounded-full flex items-center justify-center mb-3">
                  <Users className="text-rrf-dark-green w-6 h-6" />
                </div>
                <p className="text-sm text-gray-700 text-center">Digital platform tailored for refugees & rural learners</p>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 bg-rrf-light-green rounded-full flex items-center justify-center mb-3">
                  <Wifi className="text-rrf-dark-green w-6 h-6" />
                </div>
                <p className="text-sm text-gray-700 text-center">Offline, low-bandwidth formats</p>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 bg-rrf-light-green rounded-full flex items-center justify-center mb-3">
                  <Globe className="text-rrf-dark-green w-6 h-6" />
                </div>
                <p className="text-sm text-gray-700 text-center">Co-created content in local languages</p>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 bg-rrf-light-green rounded-full flex items-center justify-center mb-3">
                  <BookOpen className="text-rrf-dark-green w-6 h-6" />
                </div>
                <p className="text-sm text-gray-700 text-center">Practical, action-oriented learning</p>
              </div>
            </div>
          </div>

          <div className="text-center">
            <h3 className="text-2xl font-bold text-rrf-green mb-8">Why Go Digital?</h3>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center">
                <h4 className="font-semibold text-gray-900 mb-2">Low-cost, high-reach</h4>
                <p className="text-sm text-gray-600">Scaling education without geographical barriers</p>
              </div>
              <div className="text-center">
                <h4 className="font-semibold text-gray-900 mb-2">Flexible and self-paced</h4>
                <p className="text-sm text-gray-600">Learn at your own speed and schedule</p>
              </div>
              <div className="text-center">
                <h4 className="font-semibold text-gray-900 mb-2">Local + Global knowledge</h4>
                <p className="text-sm text-gray-600">Combining local wisdom with global expertise</p>
              </div>
              <div className="text-center">
                <h4 className="font-semibold text-gray-900 mb-2">Inclusive learning</h4>
                <p className="text-sm text-gray-600">Accessible to youth, women, and non-literate learners</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <Card>
              <CardHeader>
                <CardTitle className="text-rrf-green text-center">Permaculture Track</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2">
                  <li className="flex items-center">
                    <Check className="text-rrf-green w-4 h-4 mr-2" />
                    <span>PDC (Permaculture Design Course)</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="text-rrf-green w-4 h-4 mr-2" />
                    <span>PCMC (Permaculture Community Management Course)</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-rrf-green text-center">Mushroom Track</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2">
                  <li className="flex items-center">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-rrf-green text-center">Specialist Skills</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2">
                  <li className="flex items-center">
                    <Check className="text-rrf-green w-4 h-4 mr-2" />
                    <span>Spore Production</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="text-rrf-green w-4 h-4 mr-2" />
                  ...
                  <li className="flex items-center">
                    <Check className="text-rrf-green w-4 h-4 mr-2" />
                    <span>Spawn Multiplication</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center">
              <CardContent className="p-6">
                <div className="text-4xl font-bold text-rrf-green mb-2">500+</div>
                <p className="text-gray-700">Refugees trained on-site across multiple countries</p>
              </CardContent>
            </Card>
            <Card className="text-center">
              <CardContent className="p-6">
                <div className="text-4xl font-bold text-rrf-green mb-2">15+</div>
                <p className="text-gray-700">Acres of degraded land restored through our programs</p>
              </CardContent>
            </Card>
            <Card className="text-center">
              <CardContent className="p-6">
                <div className="text-4xl font-bold text-rrf-green mb-2">3</div>
                <p className="text-gray-700">Mushroom cooperatives established in refugee settlements</p>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="max-w-3xl mx-auto mb-12">
            <p className="text-lg text-gray-700 mb-6">
              We invite permaculture teachers, designers, funders & allies to join our mission.
            </p>
            <p className="text-lg text-gray-700 mb-8">
              Support us online and on-site. Help us regenerate ecosystems and restore dignity.
            </p>
            <p className="text-2xl font-semibold text-rrf-green mb-8">
              Together, we grow back better.
            </p>
          </div>
      ...
      <section className="py-20 px-4 bg-gray-900 text-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 bg-rrf-green rounded-full flex items-center justify-center mb-4">
                <Mail className="text-white w-6 h-6" />
              </div>
              <h3 className="font-semibold mb-2">Email</h3>
              <p className="text-gray-300">ceo@rrfuganda.org</p>
              <p className="text-gray-300">info@rrfuganda.org</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 bg-rrf-green rounded-full flex items-center justify-center mb-4">
              ...
              <p className="text-gray-300">+256 786 625299</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 bg-rrf-green rounded-full flex items-center justify-center mb-4">
              ...
              <p className="text-gray-300">Nkoma Katalyeba Town Council</p>
              <p className="text-gray-300">Uganda</p>
            </div>
          </div>
