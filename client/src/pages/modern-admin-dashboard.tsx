            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900">{systemStats.activeCourses}</p>
                  <p className="text-sm text-gray-500">of {systemStats.totalCourses} total</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900">{systemStats.totalEnrollments.toLocaleString()}</p>
                  <p className="text-sm text-green-600">{systemStats.completionRate}% completion</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900">${systemStats.revenueThisMonth.toLocaleString()}</p>
